  ...
  return (
    <section className={`rounded-2xl border ${
      ...
      <div className="relative pl-2">
        <div className={`absolute left-5 top-4 bottom-4 w-px ${isDark ? 'bg-slate-700' : 'bg-slate-200'}`} />
            ...
            >
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  <div>
                    <p className={`text-sm font-semibold ${isDark ? 'text-slate-100' : 'text-slate-900'}`}>{lesson.title}</p>
                    <p className={`text-xs mt-1 ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>{lesson.topic}</p>
                  </div>
