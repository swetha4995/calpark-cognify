...
export default function AIMentorCard({ onOpenMentor, isDark = false }) {
  return (
    ...
    >
      ...
      <div className={`relative z-10 ${isDark ? 'text-slate-100' : 'text-slate-800'}`}>
        <motion.div
        ...
        >
          ...
          <div>
            ...
            <h2 className={`text-2xl font-bold leading-tight mb-2 ${isDark ? 'text-slate-100' : 'text-slate-900'}`}>Need a quick hint?</h2>
