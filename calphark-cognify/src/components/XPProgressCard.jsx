  ...
  return (
    <div className="grid lg:grid-cols-3 gap-4 items-start min-w-0">
      <motion.div
        ...
        className={`lg:col-span-2 rounded-2xl p-5 md:p-6 min-w-0 ${
          isDark 
            ? 'skeu-card-dark' 
            : 'skeu-card'
        }`}
      >
        <div className="flex items-start justify-between gap-3 mb-5 min-w-0">
          <div className="min-w-0">
            <h2 className={`text-xl font-semibold mb-1 break-words ${isDark ? 'text-slate-100' : 'text-slate-900'}`}>Learning Progress</h2>
            <p className={`text-sm leading-relaxed break-words ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>Consistent practice compounds over time.</p>
          </div>
      ...
      <div className="space-y-4 min-w-0">
        <div className={`rounded-2xl border p-4 ${
          ...
          <p className={`text-xs mb-3 font-medium ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>Progress Snapshot</p>
          <div className="space-y-3">
            <div className={`flex items-center justify-between rounded-xl px-3 py-2 ${
              ...
              <div className={`flex items-center gap-2 min-w-0 ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>
