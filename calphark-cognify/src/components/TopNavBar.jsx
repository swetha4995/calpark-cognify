          ...
          {user && (
            <div className="relative">
              <button
                ...
                className={`h-10 pl-2.5 pr-2 rounded-xl border transition flex items-center gap-2 ${
                  isDark ? 'border-slate-700 bg-slate-800 hover:bg-slate-700' : 'border-slate-200 bg-white hover:bg-slate-50'
                }`}
              >
                ...
                <span className={`hidden md:block text-sm font-medium ${isDark ? 'text-slate-100' : 'text-slate-700'}`}>{user.name}</span>
