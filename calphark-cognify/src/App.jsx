          ...
          <div className="space-y-6">
            <div className={`${cardClass} p-8`}>
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className={`text-3xl font-bold ${isDark ? "text-slate-100" : "text-gray-900"}`}>Learning Roadmap</h1>
                  <p className={`${isDark ? "text-slate-300" : "text-gray-600"} mt-1`}>Track your personalized learning journey</p>
                </div>
              </div>
            </div>
            <LearningRoadmapComponent isDark={isDark} />
